...
# 构建CNN模型
def model_load(IMG_SHAPE=(28,28,3), class_num=10): #注意改数据集改这里路径名字和图片尺寸！！！！！ 
    # 搭建模型
...
def train(epochs):
    ...
    train_ds, val_ds, class_names = data_load("/home/pi/FashionMNIST/train",
                                              "/home/pi/FashionMNIST/test",28, 28, 16) #注意改数据集改这里路径名字和图片尺寸！！！！！
    print(class_names)
    # 加载模型
    ...
    model.save("/home/pi/CNN/models/cnn_FashionMNIST.h5")#注意改数据集改这里网络存储路径！！！！！
    # 记录结束时间
    end_time = time()
