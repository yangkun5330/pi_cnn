...
def data_set_split(src_data_folder, target_data_folder, train_scale=0.8, val_scale=0.2, test_scale=0.0):#注意改数据集改这里划分比例，也可以不改！！！！！
    '''
...
if __name__ == '__main__':
    src_data_folder = "/home/pi/NEW_data"   #注意改数据集改这里图像来源路径！！！！！
    target_data_folder = "/home/pi/split_data"  #注意改数据集改这里划分后存储路径！！！！！
