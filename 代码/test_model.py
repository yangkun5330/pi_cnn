...
def test_cnn():
    # todo 加载数据, 修改为你自己的数据集的路径
    train_ds, test_ds, class_names = data_load("/home/pi/FashionMNIST/train",
                                              "/home/pi/FashionMNIST/test", 28, 28, 16)#注意改数据集改这里路径名字和图片尺寸！！！！
    # todo 加载模型，修改为你的模型名称
    model = tf.keras.models.load_model("/home/pi/CNN/models/cnn_FashionMNIST.h5") #注意改数据集改这里网络存储路径！！！！！
    # model.summary()
    # 测试
    loss, accuracy = model.evaluate(test_ds)
    # 输出结果
